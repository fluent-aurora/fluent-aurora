...
Examples:
    ...
    python generate_translation_progress.py --directory "path\to\source\FluentAurora\Resources\Language"
...
def main():
    ...
    if args.directory:
        ...
        possible_dirs = [
            script_dir.parent / "source" / "FluentAurora" / "Resources" / "Language",
