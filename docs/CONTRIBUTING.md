...
Welcome, and thank you for your interest in contributing to FluentAurora. Please follow these guidelines to maintain
...
- **FluentAurora**: Main application project containing Views, ViewModels, and UI-related logic
- **FluentAurora.Core**: Core library containing all business logic, services, models, and utilities

All core logic should be placed in **FluentAurora.Core** to facilitate easier implementation of features across different UI platforms (Desktop App, Fullscreen App, etc.).
...
- Place all business logic in **FluentAurora.Core** project
...
- Use file-scoped namespaces:
  ```csharp
  namespace FluentAurora.Core.Manage;
...
FluentAurora supports custom themes. To create a new theme:

1. **Copy the template file**
   - Navigate to `source/FluentAurora/Resources/Themes/`
...
3. **Register your theme**
   - Open `source/FluentAurora.Core/Models/Theme.cs`
   ...
   ```
   - Open `source/FluentAurora/Services/ThemeService.cs`
   ...
   [Theme.MyCustom] = new ThemeConfiguration
   {
       ...
       ResourcePath = "avares://FluentAurora/Resources/Themes/MyCustomTheme.axaml",
...
Thank you for contributing to FluentAurora!
